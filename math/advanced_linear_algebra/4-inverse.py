...
def cofactor(matrix):
    ...
    Args:
        matrix (list of lists): The matrix whose cofactor matrix is
        to be calculated.
...
def adjugate(matrix):
    ...
    Args:
        matrix (list of lists): The matrix whose adjugate matrix is
        to be calculated.
...
def inverse(matrix):
    ...
    Args:
        matrix (list of lists): The matrix whose inverse is
        to be calculated.
